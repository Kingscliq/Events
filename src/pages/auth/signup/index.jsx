...
import { FaEnvelope, FaLock, FaEye, FaUserAlt, FaEyeSlash, FaGoogle } from "react-icons/fa";
						...
						{({ values, handleBlur, handleChange, handleSubmit }) => (
							<>
								<form className="card">
									...
									<Input type="text" className="textField" icon={<FaUserAlt />} placeholder="Enter Username" />
									...
									<Button text="Sign Up With Google" type="submit" className="btn btn-light" icon={<FaGoogle />} />
								</form>
							</>
						)}
					</Formik>
