							...
							<div className="upload-template-form-div">
								<div className="upload-template-form-div-input">
									<div className="upload-template-image">
										<img src={event.image ? URL.createObjectURL(event.image) : null} alt={event.image ? event.image.name : null} />
									</div>
									<div className="upload-template-instruction">
										<span>Drag and drop images files here</span>
										<p>Or</p>
										<div>
											<img src={UploadImageIcon} alt="upload-img icon" /> <span>Choose image fille</span>
										</div>
									</div>

									<input type="file" name="image" accept="image/*" className="position-absolute" onChange={handleChange} />
								</div>
							</div>
